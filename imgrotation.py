#--------------------------------------------------------------------------------------------------#
# imgrotation.py (formaly image_rotation.py)                                                       #
# Developed by Kiyoaki Okudaira * University of Washington / Kyushu University / IAU CPS SatHub    #
#--------------------------------------------------------------------------------------------------#
# Description                                                                                      #
#--------------------------------------------------------------------------------------------------#
# Rotate an image containing a streak or multiple streaks such that the streak is horizontal or    #
# parllel withthe x-axis                                                                           #
# This code is written for ASTR 499 undergraduate research with Dr. Meredith                       #
# This code is restructed from the satmetrix project                                               #
#--------------------------------------------------------------------------------------------------#
# History                                                                                          #
#--------------------------------------------------------------------------------------------------#
